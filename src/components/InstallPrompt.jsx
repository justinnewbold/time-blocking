      ...
      <div className="max-w-md mx-auto bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl shadow-2xl overflow-hidden">
        <div className="p-4 flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-white font-bold text-lg">Install FocusFlow</h3>
        ...
        {isIOS ? (
          <div className="px-4 pb-4">
            <div className="bg-white/10 rounded-xl p-3 space-y-2">
              ...
              <ol className="text-purple-100 text-sm space-y-1.5">
          ...
          <div className="px-4 pb-4 flex gap-2">
            ...
            <button onClick={handleInstall} className="flex-1 py-2.5 bg-white text-purple-600 font-bold rounded-xl hover:bg-purple-50 transition-colors">
              Install
            </button>
          </div>
        )}
